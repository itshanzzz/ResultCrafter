...
public readonly struct Result : IEquatable<Result>
{
   ...
   public static Result NoContent() => new(null, null);
   ...
   /// </summary>
   public static Result Accepted(string? location = null) => new(null, location);

   /// <summary>Creates a failure result carrying the given <paramref name="error"/>.</summary>
   public static Result Fail(Error error) => new(error, null);
   ...
   public bool Equals(Result other) =>
      Error == other.Error && AcceptedLocation == other.AcceptedLocation;

   /// <inheritdoc/>
   public override bool Equals(object? obj) => obj is Result other && Equals(other);

   /// <inheritdoc/>
   public override int GetHashCode() => HashCode.Combine(Error, AcceptedLocation);
