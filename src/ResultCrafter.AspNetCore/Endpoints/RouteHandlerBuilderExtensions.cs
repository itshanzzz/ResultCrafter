...
public static class RouteHandlerBuilderExtensions
{
   extension(RouteHandlerBuilder builder)
   {
      ...
      public RouteHandlerBuilder ProducesBadRequest() => builder.ProducesProblem(StatusCodes.Status400BadRequest);

      /// <summary>Documents a <c>401 Unauthorized</c> ProblemDetails response.</summary>
      public RouteHandlerBuilder ProducesUnauthorized() => builder.ProducesProblem(StatusCodes.Status401Unauthorized);

      /// <summary>Documents a <c>403 Forbidden</c> ProblemDetails response.</summary>
      public RouteHandlerBuilder ProducesForbidden() => builder.ProducesProblem(StatusCodes.Status403Forbidden);

      /// <summary>Documents a <c>404 Not Found</c> ProblemDetails response.</summary>
      public RouteHandlerBuilder ProducesNotFound() => builder.ProducesProblem(StatusCodes.Status404NotFound);

      /// <summary>Documents a <c>409 Conflict</c> ProblemDetails response.</summary>
      public RouteHandlerBuilder ProducesConflict() => builder.ProducesProblem(StatusCodes.Status409Conflict);
   }
}