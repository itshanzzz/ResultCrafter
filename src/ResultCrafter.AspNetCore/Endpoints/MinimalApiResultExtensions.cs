...
public static class MinimalApiResultExtensions
{
   ...
   /// </summary>
   public static Results<Ok<T>, ProblemHttpResult>
      ToOkResult<T>(this Result<T> result) =>
      result.IsSuccess
   ...
   /// </remarks>
   public static Results<Created<T>, ProblemHttpResult>
      ToCreatedResult<T>(this Result<T> result)
   {
      if (!result.IsSuccess)
   ...
   /// <c>ProblemDetails</c> on failure.
   /// </summary>
   public static Results<NoContent, ProblemHttpResult>
   ...
   /// <c>ProblemDetails</c> on failure.
   /// </summary>
   public static Results<Accepted<T>, ProblemHttpResult>
      ToAcceptedResult<T>(this Result<T> result) =>
      result.IsSuccess
   ...
   /// <c>ProblemDetails</c> on failure.
   /// </summary>
   public static Results<Accepted, ProblemHttpResult>
      ToAcceptedResult(this Result result) =>
      result.IsSuccess
